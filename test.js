...
console.log('\n=== 129) 新キャラ：エクレアドッグ＆ワッフルランサー（開発テスト中） ===');
{
  ...
  check('wafflelancer は charger + pierce=3', lancer.charger === true && lancer.pierce === 3);
    ...
    ['wafflelancer_body_blue','wafflelancer_body_red','wafflelancer_lance'].every(k => !!API.SPRITE_DATA[k]));
  {
    ...
    check('fighter に pierce がコピーされる', lf.pierce === 3);
  ...
  check('wafflelancer: atk30 / hp250 / dashDamage120', lancer.atk === 30 && lancer.hp === 250 && lancer.dashDamage === 120,
    { atk: lancer.atk, hp: lancer.hp, dash: lancer.dashDamage });
