...
;globalThis.__API = {
  ...
  PVP_PROTO, pvpMakeOffer, pvpMakeStepOffers, applyPvpSpecial, reapplyEnhancements, X2_OFFER_CAP, picksFor,
...
console.log('\n=== 62) キャンディキャノンの爆発範囲: 中心でも約3体まで ===');
{
  ...
  check('密集してても爆発で巻き込むのは中心3体前後（<=4）', best <= 4, { best, splash, total: foes.length });
}
